...
6. 新規記事＋未要約記事をカテゴリごとにバッチ化してClaude APIに送信
7. Claude APIが各記事の日本語要約と重要度スコアを返す
8. 要約とスコアをDBに保存
...
```
あなたは技術情報アナリストです。与えられた技術記事を分析してください。
